<template>
  <div class="announce-wrap">
    ...
    <section class="coconut-info-selection">
      ...
      >
        <NuxtLinkLocale
          :to="'/coconut-information' + item.link"
...
import pestIcon from "/icon/bugs.png";
import chainvalueIcon from "/icon/value-chain.png";
  ...
  data() {
    return {
      pagesel: [
        ...
        { label: "Pest",              icon: pestIcon, link: "/pest/",              desc: "ดูศัตรูพืชของมะพร้าว" },
        { label: "Value Chain",      icon: chainvalueIcon, link: "/value-chain/",       desc: "ดูขั้นตอนการแปรรูป และส่งออก" },
      ],
    };
  },
};
