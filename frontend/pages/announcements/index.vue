<template>
    ...
    <div style="height: 100dvh;">
        ...
        <div class="faqs-path">
            ...
            <NuxtLinkLocale to="/coconut-information/">{{ $t('News & Events') }}</NuxtLinkLocale>
...
export default {
    data() {
        return {
            ...
            pagesel: [
                { label: "News", icon: coconutIcon, link: "/coconut-varieties/", desc: "ดูพันธุ์มะพร้าว" },
                { label: "Events", icon: harvestIcon, link: "/pest/", desc: "ดูศัตรูพืชของมะพร้าว" },
